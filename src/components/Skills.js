...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold bg-[rgb(0,126,106)] text-light px-6 py-3 shadow-dark cursor-pointer absolute dark:text-[rgb(0,126,106)] dark:bg-light/95 hover:dark:bg-[rgb(0,126,106)] hover:dark:text-light "
  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark">
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold bg-dark/80 text-light p-8 shadow-slate-700 cursor-pointer px-9 dark:text-light dark:bg-[rgb(0,126,106)]"
          whileHover={{ scale: 1.05 }}
        >
          Web
        </motion.div>
